...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  put_template_custom Pg FF0000 # foreground
  put_template_custom Ph FF0000 # background
  put_template_custom Pi FF0000 # bold color
  put_template_custom Pj FF0000 # selection color
  put_template_custom Pk FF0000 # selected text color
  put_template_custom Pl FF0000 # cursor
  put_template_custom Pm FF0000 # cursor text
else
